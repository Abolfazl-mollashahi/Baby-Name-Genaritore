<template>
    <svg class="z-30 lg:w-[250px] xl:w-full" xmlns="http://www.w3.org/2000/svg" width="350" height="350"
        viewBox="0 0 692.68 534.44" xmlns:xlink="http://www.w3.org/1999/xlink">
        <path id="uuid-afa4718a-41ef-46ad-9f1b-fdedc1410b9c-71"
            ...
            fill="#ffb6b6" />
        <polygon points="347.26 139.3 306.48 112.05 223.72 237.97 245.27 261.1 347.26 139.3" fill="#6c63ff" />
        <path
        ...
        <path
            ...
            fill="#2f2e41" />
        <path id="uuid-b608ab84-b9cd-47a8-808f-666f8f7d666f-72"
            ...
            fill="#ffb6b6" />
        <polygon points="352.62 135.1 310.56 109.89 234.09 239.74 256.75 261.77 352.62 135.1" fill="#6c63ff" />
        ...
        <path
            ...
            fill="#2f2e41" />
        <path id="uuid-2fb5f450-2303-4fbd-97a7-1c64874c1514-73"
            ...
            fill="#ffb6b6" />
        <polygon points="389.52 91.12 357.13 127.95 471.07 226.57 496.83 208.26 389.52 91.12" fill="#6c63ff" />
        ...
        <path
            ...
            fill="#6c63ff" />
        <path id="uuid-2ae02034-8b61-43cb-9dde-8a75b258f379-74"
